      ...
      <div className="flex flex-col h-screen">
        <header className="border-b py-3 px-4 flex items-center justify-between bg-white">
          <div className="flex items-center gap-2">
            <Button variant="ghost" size="icon" className="text-gray-500" onClick={() => router.back()}>
              <ArrowLeft className="h-4 w-4" />
            </Button>
            <div className="flex items-center gap-1 text-sm text-gray-500">
              <span>My workspace</span>
              <span>/</span>
              <div className="h-5 bg-muted/30 rounded animate-pulse w-24" />
            </div>
          </div>
          <div className="flex items-center gap-3">
            <span className="text-xs px-2 py-1 bg-gray-100 text-gray-500 rounded">Draft</span>
  ...
  return (
    <div className="flex flex-col h-screen">
      <header className="border-b py-3 px-4 flex items-center justify-between bg-white">
        ...
        <div className="flex items-center gap-3">
          {!form.published && <span className="text-xs px-2 py-1 bg-gray-100 text-gray-500 rounded">Draft</span>}
          <span className="text-xs px-2 py-1 bg-blue-100 text-blue-500 rounded">Changes</span>
          ...
          <Button className="bg-blue-600 hover:bg-blue-700" onClick={() => handlePublishChange(!form.published)}>
            Publish
          </Button>
        </div>
      </header>
      ...
      <main className="flex-1 overflow-y-auto bg-white">
        <div className="max-w-3xl mx-auto pt-16 pb-32 px-4">
          {/* Form title section */}
          <div className="mb-12">
            <Input
              value={form.title}
              ...
              className="text-4xl font-medium border-0 p-0 focus-visible:ring-0 text-center w-full mb-4"
            />
            {form.description && (
              <Input
                ...
                className="border-0 text-muted-foreground p-0 focus-visible:ring-0 text-center w-full"
              />
            )}
          </div>
          ...
          {/* Add new field with slash command */}
